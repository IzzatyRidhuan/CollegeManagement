 ...
 */
@WebServlet(name = "EditCollegeServlet", urlPatterns = {"/EditCollegeServlet"})
public class EditCollegeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            while (rs.next()) {
                ...
                System.out.println(college.getKolejname());
            }
        }
        catch (SQLException ex) {            
        }
        
        session.setAttribute("collegeedit", college);
