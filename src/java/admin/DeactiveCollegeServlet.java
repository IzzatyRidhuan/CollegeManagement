 ...
 */
@WebServlet(name = "DeactiveCollegeServlet", urlPatterns = {"/DeactiveCollegeServlet"})
public class DeactiveCollegeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String sqlUpdate = "UPDATE kolej SET status = 'deactive' WHERE id = ?"; 
        ...
        try {
            ...
            String sqlQuery = "SELECT * FROM kolejname ORDER BY kolejname ASC";
