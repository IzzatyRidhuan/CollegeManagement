 ...
 */
@WebServlet(name = "ActiveCollegeServlet", urlPatterns = {"/ActiveCollegeServlet"})
public class ActiveCollegeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession();
        ...
        String sqlUpdate = "UPDATE kolej SET status = 'active' WHERE id = ?"; 
